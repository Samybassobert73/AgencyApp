  ...
  return (
    <>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <div className="flex items-center px-3 mb-3">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="text-sm font-medium text-gray-500">Rôle: {user.role === 'agency' ? 'Agence' : 'Prestataire'}</div>
                  </div>
                </div>
                <button
                  onClick={logout}
      ...
      <div className="hidden lg:flex h-screen fixed left-0 top-0 w-64 bg-white shadow-lg flex-col">
        <div className="p-5">
          <Link href="/dashboard" className="text-2xl font-bold text-blue-600 block mb-10">
            AgencyApp
          </Link>
